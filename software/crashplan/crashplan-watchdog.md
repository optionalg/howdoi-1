...
unit files
```
vim /etc/systemd/system/crashplan-watchdog.timer
---
[Unit]
Description=CrashPlan watchdog

[Timer]
Unit=crashplan-watchdog.service
OnCalendar=*:0/30
...
```
vim /etc/systemd/system/crashplan-watchdog.service
---
[Unit]
Description=CrashPlan watchdog service
